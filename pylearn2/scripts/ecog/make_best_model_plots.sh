...
# HG best deep models
#./make_model_plots.py ec2 'high gamma' $SCRATCH/exps/ec2_hg_a5 -o
...
#./make_model_plots.py ec2 'high gamma' $HOME/ec2_mcep -o -a
./make_model_plots.py ec2 'high gamma' $HOME/exps_ff/ec2_hg_ff -o
