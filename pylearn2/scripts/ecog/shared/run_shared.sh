...
srun -o "/scratch2/scratchdirs/jlivezey/output/$SLURM_JOB_NAME/$SLURM_JOBID.out" -N 1 -n 1 -c "$cores" python -u run_random.py "$SLURM_JOBID" "$1" "$2" "$3" "$4" "$5" "$6" "$7"
